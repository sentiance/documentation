...
| active_users | [ApplicationActivityGroup](data-reference-a-g.md#applicationactivitygroup) | The active users for the application |
...
| legal_v2 | Float | The legal driving score measures how well you adhere to speed limits. The higher your score, the more you respect the speed limits! When we do not have sufficient data the value will be -1. |
...
| handheld_calling_duration | Int | Total time in seconds the user was calling while holding the phone during the transport. |
...
| handsfree_calling_duration | Int | Total time in seconds the user was calling handsfree during the transport. |
...
| handling_without_calling_duration | Int | Total time in seconds the user held the phone without calling (assume typing, texting etc.) during the transport. |
...
| Property | Type | Description |
| :--- | :--- | :--- |
| max_magnitude | Int | Peak magnitude in m/s^2 multiplied by 100 (e.g. a value of 150 is actually 1.5 m/s^2). |
| confidence | Int | (0-100) confidence level that the crash is a true positive. |
| speed_at_impact | Int | Estimated speed in which the vehicle was travelling before the impact in m/s multiplied by a 100 (e.g., a value of 750 is actually 7.50 m/s. |
| delta_v | Int | Estimated change in velocity at impact in m/s multiplied by a 100. This is estimated from the acceleration signal. |
| waypoint | [Waypoint](data-reference-q-z.md#waypoint) | To be filled |
| on_device_ml_model | [OndeviceMLModel](data-reference-h-p.md#ondevicemlmodel) | Name of the models that were used to detect the crash. Mainly used as internal reference. |
...
| crash_feedback | [CrashFeedbackFeedback](data-reference-a-g.md#crashfeedbackfeedback) |  |
...
| Property | Type | Description |
| :--- | :--- | :--- |
| feedback_type_of_crash | [CrashFeedbackType](data-reference-a-g.md#crashfeedbacktype) | This field represents feedback about the type of the crash. |
| feedback_airbag_deployed | Boolean | This field represents feedback to confirm if the airbag was deployed during the crash. |
| feedback_car_driveable | Boolean | This field represents feedback to confirm if the vehicle was driveable after the crash. |
| feedback_confirmation | [CrashFeedbackConfirmation](data-reference-a-g.md#crashfeedbackconfirmation) | This field represents feedback to confirm if a crash happened. |
