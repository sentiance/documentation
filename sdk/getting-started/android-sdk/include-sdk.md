...
The latest version of the Sentiance SDK is **4.10.0**.
...
```groovy
implementation ('com.sentiance:sdk:4.10.0@aar') { transitive = true }
```
...
```groovy
implementation ('com.sentiance:sdk:4.10.0-R@aar') { transitive = true }
```
