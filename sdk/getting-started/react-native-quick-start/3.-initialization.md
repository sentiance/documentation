...
While `initWithUserLinkingEnabled` executes, the Sentiance SDK will publish an `SDKUserLink` event allowing you to perform [user linking](https://docs.sentiance.com/important-topics/user-linking-2.0).
